...
function drawAnnotations() {
  ...
  group.append("text")
    ...
    .attr("x", 0)
    .attr("y", 0)
    .text("Enrollment Scale (logarithmic) - The bigger the circle, the more students.");
  ...
  group.append("text")
    ...
    .attr("x", 0)
    .attr("y", 0)
    .text("CS101 and CS105 always seem to have the highest enrollment.");
  ...
  introBlock
    ...
    .attr("x", 0)
    .attr("y", 30)
    .text("2. Click on any grey cell to see a list of classes for that specific subject and level.")
    .append("tspan")
    .attr("x", 0)
    .attr("y", 50)
